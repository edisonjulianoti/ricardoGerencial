...
class TipoAtividadeHeaderList extends TPage
{
    private $form; // form
    ...
    private static $formName = 'formList_TipoAtividade';
    ...
    public function __construct($param = null)
    {
        ...
        $action_onEdit = new TDataGridAction(array('TipoAtividadeForm', 'onEdit'));
        ...
        $action_onDelete = new TDataGridAction(array('TipoAtividadeHeaderList', 'onDelete'));
        ...
        $panel = new TPanelGroup("Listagem de tipos de atividade");
        ...
        $button_cadastrar->setAction(new TAction(['TipoAtividadeForm', 'onShow']), "Cadastrar");
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["CRM","Tipos de atividade"]));
        }
