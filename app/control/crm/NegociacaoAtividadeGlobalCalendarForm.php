...
class NegociacaoAtividadeGlobalCalendarForm extends TWindow
{
    protected $form;
    private $formFields = [];
    ...
    public function __construct( $param )
    {
        ...
        $id = new TEntry('id');
        $negociacao_id = new TDBCombo('negociacao_id', 'minierp', 'Negociacao', 'id', '#{id} - {cliente->nome} - {etapa_negociacao->nome}','id asc'  );
        ...
        $row2 = $this->form->addFields([new TLabel("Negocição:", '#FF0000', '14px', null, '100%'),$negociacao_id],[new TLabel("Tipo atividade:", '#ff0000', '14px', null, '100%'),$tipo_atividade_id]);
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            $messageAction = new TAction(['NegociacaoAtividadeGlobalCalendarFormView', 'onReload']);
