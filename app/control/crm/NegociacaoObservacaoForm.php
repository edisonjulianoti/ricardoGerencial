...
class NegociacaoObservacaoForm extends TPage
{
    protected $form;
    private $formFields = [];
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Cadastro de observação da negociação");
        ...
        $btn_onshow = $this->form->addAction("Voltar", new TAction(['NegociacaoObservacaoHeaderList', 'onShow']), 'fas:arrow-left #000000');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            $object = new NegociacaoObservacao(); // create an empty object 
            ...
            TApplication::loadPage('NegociacaoObservacaoHeaderList', 'onShow', $loadPageParam); 
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new NegociacaoObservacao($key); // instantiates the Active Record 
