...
class CidadeForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $id = new TEntry('id');
        $estado_id = new TDBCombo('estado_id', 'minierp', 'Estado', 'id', '{nome}','nome asc'  );
        ...
        $row2 = $this->form->addFields([new TLabel("Nome:", '#ff0000', '14px', null, '100%'),$nome],[new TLabel("Código do IBGE:", '#ff0000', '14px', null, '100%'),$codigo_ibge]);
