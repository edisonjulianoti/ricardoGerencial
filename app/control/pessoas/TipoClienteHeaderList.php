...
class TipoClienteHeaderList extends TPage
{
    ...
    private static $formName = 'formList_TipoCliente';
    ...
    public function __construct($param = null)
    {
        ...
        $panel = new TPanelGroup("Listagem de tipo clientes");
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Pessoas","Tipo clientes"]));
        }
    ...
    { 
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                // instantiates object
                $object = new TipoCliente($key, FALSE); 
