...
class EstadoForm extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $codigo_ibge->setExitAction(new TAction([$this,'teste']));
        ...
        $row2 = $this->form->addFields([new TLabel("Sigla:", '#ff0000', '14px', null, '100%'),$sigla],[new TLabel("Código do IBGE:", null, '14px', null, '100%'),$codigo_ibge]);
