...
class ContaReceberList extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        $categoria_id->addValidation("Treta", new TRequiredValidator()); 
        ...
        $row3 = $this->form->addFields([new TLabel("Data de vencimento:", null, '14px', null, '100%'),$dt_vencimento,new TLabel("até", null, '14px', null),$data_vencimento_final],[new TLabel("Filtros rápidos:", null, '14px', null, '100%'),$filtros_rapidos]);
        ...
        $action_onShow = new TDataGridAction(array('ContaReceberFormView', 'onShow'));
        ...
        $action_onQuitar->setLabel("Quitar Conta");
        $action_onQuitar->setImage('fas:calendar-check #4CAF50');
        $action_onQuitar->setField(self::$primaryKey);
        $action_onQuitar->setDisplayCondition('ContaReceberList::onExibirQuitarConta');
        ...
        $button_cadastrar_lote = new TButton('button_button_cadastrar_lote');
        $button_cadastrar_lote->setAction(new TAction(['ContaReceberLoteForm', 'onShow']), "Cadastrar Lote");
        $button_cadastrar_lote->addStyleClass('btn-default');
        $button_cadastrar_lote->setImage('fas:plus #4CAF50');

        $this->datagrid_form->addField($button_cadastrar_lote);
        ...
        $button_quitar_em_lote->setAction(new TAction(['QuitarContaReceberLoteForm', 'onShow']), "Quitar em Lote");
        ...
        $head_left_actions->add($button_cadastrar_lote);
        ...
        $head_left_actions->add($button_quitar_em_lote);
