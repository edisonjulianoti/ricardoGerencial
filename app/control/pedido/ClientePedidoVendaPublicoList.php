...
class ClientePedidoVendaPublicoList extends TPage
{
    private $form; // form
    ...
    public function __construct($param = null)
    {
        ...
        $action_onShow = new TDataGridAction(array('ClientePedidoVendaPublicoFormView', 'onShow'));
        ...
        $panel = new TPanelGroup("Meus Pedidos");
        ...
        $btnShowCurtainFilters->setAction(new TAction(['ClientePedidoVendaPublicoList', 'onShowCurtainFilters']), "Filtros");
        ...
        $button_limpar_filtros->setAction(new TAction(['ClientePedidoVendaPublicoList', 'onClearFilters']), "Limpar filtros");
        ...
        $button_atualizar->setAction(new TAction(['ClientePedidoVendaPublicoList', 'onRefresh']), "Atualizar");
    ...
    public static function onShowCurtainFilters($param = null) 
    {
        try 
        {
            ...
            $page->setProperty('page-name', 'ClientePedidoVendaPublicoListSearch');
            $page->setProperty('page_name', 'ClientePedidoVendaPublicoListSearch');
