...
class FabricanteForm extends TPage
{
    ...
    private static $formName = 'form_FabricanteForm';
    ...
    public function __construct( $param )
    {
        ...
        $this->form->setFormTitle("Cadastro de fabricante");
        ...
        $btn_onshow = $this->form->addAction("Voltar", new TAction(['FabricanteHeaderList', 'onShow']), 'fas:arrow-left #000000');
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            TApplication::loadPage('FabricanteHeaderList', 'onShow', $loadPageParam); 
