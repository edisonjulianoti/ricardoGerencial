...
class PedidoVendaList extends TPage
{
    ...
    public function __construct($param = null)
    {
        ...
        $estado_pedido_venda_id = new TDBSelect('estado_pedido_venda_id', 'minierp', 'EstadoPedidoVenda', 'id', '{nome}','nome asc'  );
        ...
        $panel = new TPanelGroup("Listagem de pedidos de venda");
        ...
        if(empty($param['target_container']))
        {
            $container->add(TBreadCrumb::create(["Pedido","Pedidos de venda"]));
        }
