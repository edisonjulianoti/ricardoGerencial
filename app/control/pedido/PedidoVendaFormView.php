...
class PedidoVendaFormView extends TPage
{
    ...
    public function __construct( $param )
    {
        ...
        $linha_do_tempo->setAction(new TAction(['PedidoVendaHistoricoTimeLine', 'onShow'], ['key' => $pedido_venda->id]));
        ...
        $row5 = $this->form->addFields([$linha_do_tempo]);
        $row5->layout = [' col-sm-12'];

        $btnPedidoVendaFormOnEditAction = new TAction(['PedidoVendaForm', 'onEdit'],['key'=>$pedido_venda->id]);
        $btnPedidoVendaFormOnEditLabel = new TLabel("Editar");

        $btnPedidoVendaFormOnEdit = $this->form->addHeaderAction($btnPedidoVendaFormOnEditLabel, $btnPedidoVendaFormOnEditAction, 'fas:edit #03A9F4'); 
        $btnPedidoVendaFormOnEditLabel->setFontSize('12px'); 
        $btnPedidoVendaFormOnEditLabel->setFontColor('#333'); 

        $btnPedidoVendaDocumentOnGenerateAction = new TAction(['PedidoVendaDocument', 'onGenerate'],['key'=>$pedido_venda->id]);
        $btnPedidoVendaDocumentOnGenerateLabel = new TLabel("Documento");

        $btnPedidoVendaDocumentOnGenerate = $this->form->addHeaderAction($btnPedidoVendaDocumentOnGenerateLabel, $btnPedidoVendaDocumentOnGenerateAction, 'far:file-pdf #9C27B0'); 
        $btnPedidoVendaDocumentOnGenerateLabel->setFontSize('12px'); 
        $btnPedidoVendaDocumentOnGenerateLabel->setFontColor('#333'); 
