...
CREATE TABLE ouvidoria( 
      ...
      mensagem blob sub_type 1    NOT NULL , 
      created_at timestamp   , 
      updated_at timestamp   , 
      deleted_at timestamp   , 
 PRIMARY KEY (id)) ; 
...
ALTER TABLE estado_pedido_venda_aprovador ADD CONSTRAINT estado_pedido_venda_aprovador_64dfa65f7e53d FOREIGN KEY (estado_pedido_venda_id) references estado_pedido_venda(id); 
ALTER TABLE estado_pedido_venda_aprovador ADD CONSTRAINT estado_pedido_venda_aprovador_64dfa65f7e597 FOREIGN KEY (aprovador_id) references aprovador(id); 
ALTER TABLE matriz_estado_pedido_venda ADD CONSTRAINT matriz_estado_pedido_venda_64dfa65f7ed98 FOREIGN KEY (estado_pedido_venda_origem_id) references estado_pedido_venda(id); 
ALTER TABLE matriz_estado_pedido_venda ADD CONSTRAINT matriz_estado_pedido_venda_64dfa65f7edd9 FOREIGN KEY (estado_pedido_venda_destino_id) references estado_pedido_venda(id); 
...
ALTER TABLE negociacao_historico_etapa ADD CONSTRAINT negociacao_historico_etapa_64dfa65f7f7e2 FOREIGN KEY (negociacao_id) references negociacao(id); 
ALTER TABLE negociacao_historico_etapa ADD CONSTRAINT negociacao_historico_etapa_64dfa65f7f82a FOREIGN KEY (etapa_negociacao_id) references etapa_negociacao(id); 
