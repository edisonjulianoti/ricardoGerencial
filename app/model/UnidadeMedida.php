...
class UnidadeMedida extends TRecord
{
    ...
    public function get_produto_tipo_produto_to_string()
    {
        ...
        $values = Produto::where('unidade_medida_id', '=', $this->id)->getIndexedArray('tipo_produto_id','{tipo_produto->nome}');
    ...
    public function get_produto_familia_produto_to_string()
    {
        ...
        $values = Produto::where('unidade_medida_id', '=', $this->id)->getIndexedArray('familia_produto_id','{familia_produto->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_produto_fornecedor_to_string()
    {
        ...
        $values = Produto::where('unidade_medida_id', '=', $this->id)->getIndexedArray('fornecedor_id','{fornecedor->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_produto_unidade_medida_to_string()
    {
        ...
        $values = Produto::where('unidade_medida_id', '=', $this->id)->getIndexedArray('unidade_medida_id','{unidade_medida->nome}');
        return implode(', ', $values);
    }
    ...
    public function get_produto_fabricante_to_string()
    {
        ...
        $values = Produto::where('unidade_medida_id', '=', $this->id)->getIndexedArray('fabricante_id','{fabricante->nome}');
        return implode(', ', $values);
    }
